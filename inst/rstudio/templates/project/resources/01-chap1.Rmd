...
First Level Subheadings are in Title Case (every principal word is capitalized, except, prepositions, conjunctions, and articles.

## Second Level Subheading
Second Level headings are also in Title Case, but are left-aligned instead of centered.

### Third level subheading
Third level headings are left-aligned, but are in sentence case (The first word and any proper nouns are capitalized).
